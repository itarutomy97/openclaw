...
- 複数人に話しかけるとき: `@itarutomy <@1484089242102661333>` のように両方付ける
- **メンションなしのメッセージは送らない。** 誰に向けた発言か常に明示する。

### Examples

- `<@1484089242102661333> 了解、調べてみます。`
- `@itarutomy 調査結果を報告します。`
- `@itarutomy <@1484089242102661333> この件について確認が必要です。`
