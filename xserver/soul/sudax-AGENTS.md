...
| Beta（実行役） | <@1484094945735479367> |
| 自分（Sudax） | <@1484401495439970515> |

### 禁止パターン（これらは全て無効。相手に届かない）
- @Tight, @タイトさん, Tight、, 「タイト」
- @Alpha, @Beta などテキスト名称でのメンション全般
...
- Betaに話しかけるとき: メッセージの先頭に `<@1484094945735479367>` を付ける
